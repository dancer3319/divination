<?php /* Smarty version 2.6.25, created on 2021-05-11 01:46:37
         compiled from ffsm/userreg.tpl */ ?>
﻿
<!DOCTYPE html>
<html>
<head>
...
<script language="javascript">
	...
	function CheckUser()
	{
		if(!checkLength("username" , "用户名称" , 3 , 16 , "~!@#$%^&*+=\\\'\"\<\>"))
			return false;
      $.get("/?ac=userreg&is_username="+ RegForm.username.value,function(data,status){javascript:;
        	$("#msgubotj1").html(data);
			$("#msgubotj1").show();
		});
...
<div class="form_up">
<div class="username"><span style="float:left;">用&nbsp;&nbsp;户&nbsp;&nbsp;名(必填)：</span>
...
<div class="username"><span style="float:left;">昵&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;称(必填)：</span>
<input type="text" id="nickname" name="nickname" placeholder="请输入您的用户名" class="input1">
</div>
<div class="username"><span style="float:left;">常用邮箱(可选)：</span>
<input type="text" name="email" id="email" placeholder="请输入您的邮箱" class="input1" >
</div>
<div class="username"><span style="float:left;">输入密码(必填)：</span><input type="password" name="password" id="password" placeholder="请输入您的密码" class="input1"></div>
<div class="username"><span style="float:left;">确认密码(必填)：</span>
