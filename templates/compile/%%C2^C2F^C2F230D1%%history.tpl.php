<?php /* Smarty version 2.6.25, created on 2021-05-11 01:46:32
...
<div class="public_orders_search">
	<div class="public_os_info">
		温馨提示：已经付款的用户请输入订单号查询测试结果！如未正常显示请添加微信号【<?php echo $this->_tpl_vars['weixinhao']; ?>
】反馈！
	</div>
	<ul class="problem_feedback">
		<li><a class="after_sales_link" href="http://wpa.qq.com/msgrd?v=3&uin=88888888&site=qq:88888888&menu=yes" hidetxt="问题反馈">问题反馈</a></li>
