        ...
        <div class="f-box">
         <ul class="form">
          ...
          <li class="clear">
           ...
           <div class="auto">
            <input type="text" id="birthday" data-input-id="b_input" class="Js_date" data-type="0" value="请选择出生日期" placeholder="请选择日期" data-toid-hour="birthday"   data-date="2021-1-1" readonly="" placeholder="请选择(必填)" />
           </div></li>
          <li class="textarea">
           <div class="label">
            您的愿望:
      ...
      <div class="new-comment mai_d">
       ...
       <div class="marquee-wrapper">
        <ul class="comment-list info-list-box" >
         <li><p class="user">订单号：KHFZOK***TIO76 女 25岁</p><p class="detail">2021要高考了，点一盏光明灯和文昌灯，祈求能考上心仪的大学！</p></li>
