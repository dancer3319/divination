...
<head>
<meta charset="UTF-8"/>
<title>牛年运势详批、2021流年运程运势大全-<{$zhanming}></title>
	...
	<form class="J_ajaxForm J_testFixedShow" id="submit1" action="?ac=jinnian" name="login" method="post" onSubmit="return checkForm();">
		<div class="public_form_wrap" id="miaodian">
			<ul>
				...
				<div class="auto">
					<input type="text" id="birthday" data-input-id="b_input" class="Js_date" data-type="0" value="<{if $smarty.cookies.bzjpymd==null}>请选择出生日期<{else}><{$smarty.cookies.bzjpymd}><{/if}>" placeholder="请选择出生日期" data-toid-hour="birthday" data-date="2021-1-1">
				</div>
				</li>
