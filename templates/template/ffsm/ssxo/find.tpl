...
<html lang="en"><head>
  ...
  <link rel="stylesheet" href="/statics/ffsm/ssxo/css/swiper.min.css">
  <link rel="stylesheet" href="/statics/ffsm/ssxo/css/style.css">
  
  <link rel="shortcut icon" href="/statics/ffsm/favicon.ico"/>
  <link href="/statics/ffsm/ssxo/css/page1.css" rel="stylesheet" type="text/css"/>
  ...
  <link rel="stylesheet" type="text/css" href="/statics/ffsm/ssxo/css/mobileSelect.css">
  <script src="/statics/ffsm/ssxo/js/mobileSelect.min.js" type="text/javascript"></script>
...
<div class="taohuazhi J_testFixedShow">
	...
	<div class="taohuazhi_data">
		<div class="taohuazhi_data_info">
			<span class="taohuazhi_data_info_l">忠诚值</span><span class="taohuazhi_data_info_r"><{$ssysdata.date_jqs.zc}>/100</span>
		</div>
		<div class="taohuazhi_data_info">
...
<div class="later_tip_bgsz bg_fff" style="padding: 0;">
	<div class="layui-card">
	  ...
	  <div class="layui-card-body">
		...
		<p>③ 使用方法：
“桃花值”高时，多与之交往。在相关数值显红时，进行对应的行动。</br>如：”精”数值显红时，多进行运动；”气”数值显红时，多与人结交；”神”数值显红时，多思考。</p></br>
	  </div>
	</div>
</div>
<div class="wrapper">
...
<script>
  ...
  <script src="/statics/ffsm/ssxo/js/swiper.min.js"></script>
...
<div class="ainuo_foot_nav cl" id="testFixedBtn" style="display: none;">
    <ul>
     ...
     <li><a href="?ac=ssxo"><em><i class="lijics_1"></i></em><p>继续测算</p></a></li>
