...
<head>
<meta charset="UTF-8"/>
<title><{$data.username}>的紫微命盘精批-<{$zhanming}></title>
...
<div class="public_box border1">
	...
	<p class="test_number">
		已有<span>4985554</span>缘主进行在线测试，知晓了自己事业财运、婚姻情感的情况，并根据老师建议做出调整，产生显著效果，<span>95%</span>用户觉得本测试对人生规划发展有帮助！
	</p>
...
<div class="public_box J_payPopupShow">
	...
	<p class="teacher_say_bottom">
		紫微斗数是古代帝王专用测试方法，号称“天下第一神数”。专业易学权威团队40年紫微斗数论命经验总结，打造最准紫微斗数一生命格详批！
	</p>
</div>
