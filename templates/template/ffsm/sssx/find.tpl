...
<html lang="en"><head>
  ...
  <link rel="stylesheet" href="/statics/ffsm/sssx/css/swiper.min.css">
  <link rel="stylesheet" href="/statics/ffsm/sssx/css/style.css">
  
  <link rel="shortcut icon" href="/statics/ffsm/favicon.ico"/>
  <link href="/statics/ffsm/sssx/css/page1.css" rel="stylesheet" type="text/css"/>
  ...
  <link rel="stylesheet" type="text/css" href="/statics/ffsm/sssx/css/mobileSelect.css">
  <script src="/statics/ffsm/sssx/js/mobileSelect.min.js" type="text/javascript"></script>
...
<div class="later_tip_bgsz bg_fff" style="padding: 0;">
	<div class="layui-card">
	  ...
	  <div class="layui-card-body">
		...
		<p>③ 抓住高”效率值”时间，进行学习、思考。在相关数值显红时，进行对应的行动。如：”精” ”神”数值显红时，多进行运动、学习和思考；”气”数值显红时，多与人结交。</p></br>
	  </div>
	</div>
</div>
<div class="wrapper">
...
<script>
  ...
  <script src="/statics/ffsm/sssx/js/swiper.min.js"></script>
...
<div class="ainuo_foot_nav cl" id="testFixedBtn" style="display: none;">
    <ul>
     ...
     <li><a href="?ac=sssx"><em><i class="lijics_1"></i></em><p>继续测算</p></a></li>
