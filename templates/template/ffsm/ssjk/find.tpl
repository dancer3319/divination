...
<html lang="en"><head>
  ...
  <link rel="stylesheet" href="/statics/ffsm/ssjk/css/swiper.min.css">
  <link rel="stylesheet" href="/statics/ffsm/ssjk/css/style.css">
  
  <link rel="shortcut icon" href="/statics/ffsm/favicon.ico"/>
  <link href="/statics/ffsm/ssjk/css/page1.css" rel="stylesheet" type="text/css"/>
  ...
  <link rel="stylesheet" type="text/css" href="/statics/ffsm/ssjk/css/mobileSelect.css">
  <script src="/statics/ffsm/ssjk/js/mobileSelect.min.js" type="text/javascript"></script>
...
<div class="later_tip_bgsz bg_fff" style="padding: 0;">
	<div class="layui-card">
	  ...
	  <div class="layui-card-body">
		...
		<p>③ 在相关数值显红时，进行对应的行动。如：”精”数值显红时，多进行运动、进补；”气”数值显红时，多与人结交；”神”数值显红时，多思考。</p></br>
	  </div>
	</div>
</div>
<div class="wrapper">
...
<script>
  ...
  <script src="/statics/ffsm/ssjk/js/swiper.min.js"></script>
...
<div class="ainuo_foot_nav cl" id="testFixedBtn" style="display: none;">
    <ul>
     ...
     <li><a href="?ac=ssjk"><em><i class="lijics_1"></i></em><p>继续测算</p></a></li>
