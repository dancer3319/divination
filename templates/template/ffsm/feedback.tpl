...
<p class="public_banner">
	<img src="/statics/ffsm/index/1/images/topbanner.gif.jpeg" alt="付费测试"/>
</p>
<div class="public_orders_search">
	<div class="public_os_info">
		温馨提示：未付款订单只能通过订单号查询，已付费测试可通过绑定手机号查看。
	</div>
		...
		<div class="as_form">
			...
			<form class="J_ajaxForm" action="/?ac=feedback" method="post">
				<div class="input_text">
					<span class="on">姓名：</span><input type="text" name="username" placeholder="你测试时填写的姓名">
				</div>
				<div class="input_text">
