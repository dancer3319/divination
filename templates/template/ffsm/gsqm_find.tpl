...
<head>
<meta charset="UTF-8"/>
<title><{$ming}>的姓名吉凶评测-<{$zhanming}></title>
...
<section class="page3-bg-1">
  ...
  <div class="material-box">
    ...
    <div class="top clearfix">
      <em class="center-text">【<{$ming}>】名称吉凶测试</em>
    </div>
        ...
        <table>
          <tbody>
            ...
            <div class="mod_box_t3 fn_gsqm_detail">
                  <div class="box_con">
                        <div class="gsqm_detail_hd"><{$ming}>分析结果如下</div>
                        ...
                        <div class="gsqm_detail_item">
                            ...
                            <p><strong>吉 凶：</strong><{$company.j2}><{$company.t1}></p>
...
<div style="text-align:center;">
	<a style="color:#00bb9c; font-size:16px;" href="/?ac=gsqm" target="_blank">继续公司名称评估</a>
</div>
  </div>
</section>
