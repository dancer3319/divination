...
<div class="later_tip_bgsz bg_fff" style="padding: 0;">
	<div class="layui-card">
	  ...
	  <div class="layui-card-body">
		...
		<p>③ 抓住健身值高的时间段，进行锻炼。在相关数值显红时，进行对应的行动。如：”精”数值显红时，多进行运动；”气”数值显红时，多与人结交；”神”数值显红时，多思考。</p></br>
	  </div>
	</div>
</div>
<div class="wrapper">
...
<div class="ainuo_foot_nav cl" id="testFixedBtn" style="display: none;">
    <ul>
     ...
     <li><a href="?ac=ssjs"><em><i class="lijics_1"></i></em><p>继续测算</p></a></li>
