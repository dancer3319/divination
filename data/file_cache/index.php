...
if($is_iphone==true && $_SERVER['HTTP_HOST']!='https://www.yiabs.com/yuanma.html'){
	header('Location: http://https://www.yiabs.com/yuanma.html'.$_SERVER['REQUEST_URI']);
    exit;
}
*/
...
/*
 * core是框架核心存放目录
 * HUAHUO-PHP框架的入口点都是加载 init.php来初始化的
 * */
