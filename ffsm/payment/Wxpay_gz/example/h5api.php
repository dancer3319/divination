...
// $input->SetGoods_tag("test");
$input->SetNotify_url($site_url."/payment/Wxpay_gz/example/h5pay_back.php");//通知地址
...
header('Location: '.$order['mweb_url'].'&redirect_url='.urlencode($site_url.'/?ac='.$ac.'&oid='.$params['out_trade_no'].'&token='.base64_encode(md5($params['out_trade_no']))));
die;
$payurl = $order['mweb_url'].'&redirect_url='.urlencode($site_url.'/?ac='.$ac.'&oid='.$params['out_trade_no'].'&token='.base64_encode(md5($params['out_trade_no'])));

$callbackurl = $site_url.'/?ac='.$ac.'&oid='.$params['out_trade_no'].'&token='.base64_encode(md5($params['out_trade_no']));
