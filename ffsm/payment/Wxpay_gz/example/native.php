...
$input->SetNotify_url($site_url."/payment/Wxpay_gz/example/native_callback.php");
...
<div class="bc_c">
<div class="bc_c_list">
<div class="img_tel"><p class="pic"><img src="<?=$site_url?>/m/tu/weixinyindao.jpg" class="引导图片"></p><p class="words">打开手机微信，在“发现”菜单中点击“扫一扫”</p></div>
</div>
<div class="bc_c_list">
<div class="weixin"><p></p>
<div id="code"><img src="<?=$site_url?>/payment/Wxpay_gz/example/qrcode.php?data=<?php echo urlencode($url2);?>"></div>
<p></p>
