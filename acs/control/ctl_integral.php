...
class ctl_integral extends common{
    // 自动验证设置
    protected $_submit_validate     =   array(
		'tx_txfs'=>array('','notempty','收款平台必须','all'),
        'tx_txzh'=>array('','notempty','收款账号必须','all'),
        'tx_txnc'=>array('','notempty','收款昵称必须','all'),
		'tx_jf'=>array('','notempty','提现积分必须','all'),
	...
	protected $tx_scs = array(0=>'等待打款',1=>'打款成功',2=>'无效退回');
    ...
    public function __construct()
    {
        ...
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('id'=>'编号','uid'=>'用户id','tx_txfs'=>'收款平台','tx_txzh'=>'账号','tx_txnc'=>'昵称','tx_jf'=>'提现积分','tx_je'=>'提现金额','tx_sc'=>'操作状态','tx_txbz'=>'备注','tx_txtel'=>'电话','add_time'=>'添加时间'),
            'addTableField'=>array('tx_txfs','tx_txzh','tx_txnc','tx_jf'),
			
            'editTableField'=>array('tx_txfs','tx_txzh','tx_txnc','tx_jf','tx_je','tx_sc','tx_txbz'),
           
            'listTableField'=>array('id','uid','tx_txfs','tx_jf','tx_je','tx_txzh','tx_txnc','tx_sc','tx_txtel','tx_txbz','add_time'),
			...
			'tx_sc'=>array(
                'element'=>array('e_name'=>'select','datafrom'=>$this->tx_scs),
				'search'=>'1',
            ),
            'tx_txzh'=>array(
