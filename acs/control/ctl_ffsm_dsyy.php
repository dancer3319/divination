...
class ctl_ffsm_dsyy extends common{
    ...
    public function __construct()
    {
        ...
        $this->_dbfield=array(
            'mainKey'=>'id',
            'allTableField'=>array('id'=>'编号','sorting'=>'排序','project'=>'项目','teacher'=>'大师','money'=>'金额','title'=>'标题','images'=>'图片url','centent'=>'摘要','about'=>'联系方式'),
            'addTableField'=>array('sorting','project','teacher','money','title','images','centent','about'),
			
            'editTableField'=>array('sorting','project','teacher','money','title','images','centent','about'),
           
            'listTableField'=>array('id','sorting','project','teacher','money','title','images','centent','about'),
