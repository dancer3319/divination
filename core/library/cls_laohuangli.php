...
class cls_laohuangli
{
	...
	public static function get_hdjr($date)
	{
		...
		$url = "http://cqapi.xlibbs.com/?ct=api&ac=huangli_ajax&type=".$date;
	...
	public static function zeri($s_time,$e_time,$lmanacType,$lmanacCond){
		...
		$data = file_get_contents('http://cqapi.xlibbs.com/?ct=api&ac=zeri&s_time='.$s_time.'&e_time='.$e_time.'&lmanacType='.$lmanacType.'&lmanacCond='.$lmanacCond);
		$data=json_decode($data,true);
