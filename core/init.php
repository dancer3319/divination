...
// 严格开发模式  E_ALL & ~E_NOTICE & ~E_WARNING
...
//免费版表单增加按钮链接到付费测算
$GLOBALS['config']['ff_url']['bazijp']="https://sm.yiabs.com/?ac=bazijp";
$GLOBALS['config']['ff_url']['bazijp_t']="付费测算";
$GLOBALS['config']['ff_url']['hehun']="https://sm.yiabs.com/?ac=hehun";
$GLOBALS['config']['ff_url']['hehun_t']="付费测算";
$GLOBALS['config']['ff_url']['xmpd']="https://sm.yiabs.com/?ac=xmpd";
$GLOBALS['config']['ff_url']['xmpd_t']="付费测算";
$GLOBALS['config']['ff_url']['ffqm']="https://sm.yiabs.com/?ac=ffqm";
$GLOBALS['config']['ff_url']['ffqm_t']="付费测算";
$GLOBALS['config']['ff_url']['xmfx']="https://sm.yiabs.com/?ac=xmfx";
$GLOBALS['config']['ff_url']['xmfx_t']="付费测算";
$GLOBALS['config']['ff_url']['bazi']="https://sm.yiabs.com/?ac=bazi";
$GLOBALS['config']['ff_url']['bazi_t']="付费测算";
$GLOBALS['config']['ff_url']['hmjx']="https://sm.yiabs.com/?ac=hmjx";
...
function run_controller(){
    try{
        ...
        if( method_exists ( $ctl, $ac ) === true ){
            ...
            $instance = new $ctl ( );//ctl_ffsm_h5_index	
			;
            $instance->$ac ();
