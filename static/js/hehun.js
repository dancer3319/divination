function checkForm_hehun(){
var name=document.login.user.value;
var xing=document.login.user_a.value;
if(xing == ""){ alert("没有填姓名吧！");document.login.user.focus();return false;}
if(name == ""){ alert("没有填姓名吧！");document.login.user_a.focus();return false;}
var b_input = document.getElementById('birthday').getAttribute("data-date");
var b_input1 = document.getElementById('birthday3').getAttribute("data-date");
	...
	login.month.value = m;
	login.day.value = d;
	login.year_a.value = y1;
	login.month_a.value = m1;
	login.day_a.value = d1;
